...
const Navbar = async () => {
  return (
    <nav className="fixed top-0 z-50 mx-auto flex w-full items-center justify-between gap-x-5 py-6 transition-all duration-300 md:left-1/2 md:w-auto md:-translate-x-1/2 md:justify-center md:px-0">
      ...
      <Dock className="bg-background text-foreground hidden flex-row items-center space-x-16 rounded-2xl border border-gray-400 px-12 text-sm whitespace-nowrap shadow-sm md:flex">
