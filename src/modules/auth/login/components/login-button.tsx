export const LoginButton = () => {
  return (
    <button className="from-primary to-primary-light text-background hover:from-primary-light hover:to-primary mx-0 hidden h-12 cursor-pointer items-center justify-center space-x-1 rounded-2xl bg-linear-to-tl px-7 transition-colors duration-300 md:flex">
